    ...
    <div class="container" align="center" style="max-width: 800px;">
        ...
        <div class="my-auto">
            ...
            <form id="review-form" action="includes/review-helper.php" method="post">
                ...
                <div class="form-group" stryle="margin-top: 15px;">
                ...
                <div class="form-group">
                    <button class="btn btn-outline-danger" type="submit" name="review-submit" style="width: 100%;"
                        id="review-submit">Review</button>
                </div>
            </form>
