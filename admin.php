        ...
        <div class="my-auto">
            ...
            <form action="includes/gallery-helper.php" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    <img src="images/3.jpg" alt="profile pic" onclick="triggered();" id=gallery-display>
                ...
                <div class="form-group">
                    <button type="submit" name="gallery-submit" class="btn btn-outline-success btn-large btn-block">upload</button>
                </div>
